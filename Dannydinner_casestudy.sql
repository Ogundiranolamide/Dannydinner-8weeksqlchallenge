...
-- LET'S FIND ALL POINTS FOR CUSTOMER A (THIS QUERY IS HARD CODED --NOT THE BEST WAY TO SOLVE) 
select
	sl.customer_id,
	product_name,
	order_date,
	...
	price,
	(CASE
		when join_date between '2021-01-07' and '2021-01-13' and order_date between '2021-01-07' and '2021-01-13' THEN (price * 10)* 2
		ELSE price * 10
	END )as Points
from sales sl
left join members mb
...
and sl.customer_id = 'A'

-- finding the sum at the end of January for A
select
	sl.customer_id,
	sum (CASE
		when join_date between '2021-01-07' and '2021-01-14' and order_date between '2021-01-07' and '2021-01-14' THEN (price * 10)* 2
		ELSE price * 10
		END )as Points
from sales sl
left join members mb
...
-- LET'S FIND ALL POINTS FOR CUSTOMER B (THIS QUERY IS HARD CODED --NOT THE BEST WAY TO SOLVE)
select
	sl.customer_id,
	product_name,
	order_date,
	...
	price,
	(CASE
		when join_date between '2021-01-09' and '2021-01-16' and order_date between '2021-01-09' and '2021-01-16' THEN (price * 10)* 2
		ELSE price * 10
	END )as Points
from sales sl
left join members mb
...
and order_date between '2021-01-01' and '2021-01-31'
and sl.customer_id = 'B'

-- finding the sum at the end of January for B
select
	sl.customer_id,
	sum(CASE
		when join_date between '2021-01-09' and '2021-01-15' and order_date between '2021-01-09' and '2021-01-15' THEN (price * 10)* 2
		ELSE price * 10
		END )as Points
from sales sl
left join members mb
